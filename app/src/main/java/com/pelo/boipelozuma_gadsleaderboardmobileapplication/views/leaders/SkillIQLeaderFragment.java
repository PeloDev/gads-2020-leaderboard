...
public class SkillIQLeaderFragment extends Fragment implements
    ...
    private void setupRecyclerView() {
        learners = LearnersManager.getInstance().getSkillLearners();
        if (learners.size() < 1) {
            learners = new ArrayList<>();
            LearnersManager.getInstance().setSkillIQLearners(getActivity(), new StringCallback() {
                @Override
